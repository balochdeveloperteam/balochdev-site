...
export default function AdminOverview() {
  ...
  return (
    ...
    >
      ...
      {err && (
        <p className="ndx-tech-blurb" style={{ color: '#f87171', marginBottom: '1rem' }}>
      ...
      <div className="ndx-admin-stat-grid">
        {cards.map((card) => (
          <div key={card.label} className="ndx-admin-stat-card ndx-glass-section">
      ...
      <p className="ndx-tech-blurb" style={{ marginTop: '1.25rem' }}>
        Manage articles and image-caption posts from the Blog Posts tab. Public post pages and comments ship in Part 2.
      </p>
    </motion.div>
  );
}
